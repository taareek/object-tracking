...
class DeepSort(object):
    ...
    def _xywh_to_xyxy(self, bbox_xywh):
        # debug
        # print(f"Box as _xywh: {bbox_xywh}")
        # print(f"Box _xywh shape: {bbox_xywh.shape}")
        x,y,w,h = bbox_xywh
        x1 = max(int(x-w/2),0)
    ...
    def _get_features(self, bbox_xywh, ori_img):
        ...
        for box in bbox_xywh:
            # debug
            # print(f"Box from the _get_features: {box}")
            # print(f"_get features box shape: {box.shape}")
